      ...
      wayland.windowManager.hyprland = {
        ...
        settings = {
          ...
          workspace = [
            ...
            # SLATED 2026-07-22 - "special:discord, monitor:HDMI-A-1, on-created-empty:vesktop"
          ...
          bind = [
            ...
            # SLATED 2026-07-22 - "SUPER, D, exec, [workspace 3; monitor hdmi-a-1] vesktop"
            "SUPER, Q, killactive"
            ...
            # SLATED 2026-07-22 - "SUPER, D, togglespecialworkspace, discord"
            "SUPER SHIFT, X, movetoworkspace, special:magic"
            "SUPER SHIFT, Z, movetoworkspace, special:scratch"
            # SLATED 2026-07-22 - "SUPER SHIFT, D, movetoworkspace, special:discord"
