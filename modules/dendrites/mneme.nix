{
  nixos =
    ...
    let
      ...
      # it. Both repos are private and both builds now authenticate the same way
      # — through the rebuilding user's git credential helper, at evaluation
      # time — so neither needs the other.
