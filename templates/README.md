...
| a new look (a rice) | `example-provider.nix` | `song/songbook/<name>/rice.nix` | one line in `song/songbook/default.nix`; author `livery.json` beside it and lint it with `lyra livery lint` |
